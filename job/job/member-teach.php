...
<ul class="breadcrumb" style="margin-bottom: 5px;">
                ...
                <li><a href="#">ข้อมูลการศึกษาระดับ ปริญญาเอก</a></li>
...
<!---/form register---->
 ...
 <div class="form-group">
    ...
    <div class="col-md-8">
      <textarea rows="3" class="form-control" name="to" id="to"><?=$data[plan_other];?></textarea>
	 <div id="from" class="add_category">
<?
	$sql_type="select * from  tb_lang"; 
	$result_type=mysql_db_query($dbName,$sql_type);
	while ($r_type=mysql_fetch_array($result_type)) {
    $type_name=$r_type["category_name"];
echo "<a href='#'><div class=list_facility>$type_name</div></a>\n";
	  }
	  ?>
    </div>	
    </div>
