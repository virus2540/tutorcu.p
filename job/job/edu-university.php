...
<html lang="en">
  <head>
    ...
    <title>ข้อมุลการเรียนระดับมหาวิทยาลัย</title>
    <!-- Bootstrap core CSS -->
...
<ul class="breadcrumb" style="margin-bottom: 5px;">
	...
	<div id="teach"><h1><span style="color:#000;">ข้อมูลด้านการศึกษา</span>   <span style="color:#358607;">ระดับปริญาตรี</span></h1></div>
<form method="POST" id="validation-form" action="./eduuniversity-complete.php" enctype="multipart/form-data">
<!---/form register---->
