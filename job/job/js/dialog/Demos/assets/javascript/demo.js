...
window.addEvent("domready", function(e){
  ...
  $("modal-ajax").addEvent("click", function(e){
    ...
    var SM = new SimpleModal({"btn_ok":"Confirm button", "width":600});
        ...
        SM.show({
          ...
          "param":{
            "url":"http://localhost/newcondo/media/index.html",
  ...
  $("modal-nofooter").addEvent("click", function(e){
    ...
    var SM = new SimpleModal({"hideFooter":true, "width":710});
        SM.show({
          "title":"อัพโหลด รูป Gallery",
          "model":"modal",
          "contents":'<iframe src="http://localhost/newcondo/media/index.php?id=2" width="680" height="382" frameborder="0" webkitAllowFullScreen allowFullScreen></iframe>'
        });
  })
