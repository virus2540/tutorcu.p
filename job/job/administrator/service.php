...
<div>
  ...
  <div class="wapper">
    <div id="nav" ><a href="<?=$url_root;?>">หน้าหลัก</a> &gt; บริการอื่นๆ</div>
<div>
    <div class="left_menu">
...
<div style="float:right;margin-bottom:10px"> <input type="button" class="da-button blue large" value="เพิ่มประเภทบริการ"  onclick="window.location='./add-service.php'" /></div>
  								<div class="clear"></div>
<div id="da-ex-tabs">
                                    <ul>
                                        <li><a href="#tabs-1">ประเภทบริการ</a></li>
                                    </ul>
   <div id="tabs-1">
...
<div id="content">
<?php
$str="select *from tb_otherservice order by service_id asc"; 
