...
<div>
  ...
  <div class="wapper">
    <div id="nav" ><a href="<?=$url_root;?>">หน้าหลัก</a> &gt;  ข้อมุลสมาชิกทั้งหมด</div>
<div>
    <div class="left_menu">
...
<div id="da-ex-tabs">
                                    <ul>
                                        <li><a href="#tabs-1">สมาชิกปกติ</a></li>
                                        <li><a href="#tabs-2">สมาชิก vip</a></li>
                                    </ul>
   <div id="tabs-1">
...
<div id="content">
<?php
$str="select *from tb_resturant where status='yes' order by prakad_id desc"; 
...
<div id="content">
<?php
$str="select *from tb_resturant where status='no' order by prakad_id desc"; 
