...
$strTable = "tb_contact";
$strCondition = "con_id='".$_GET[id]."'";
$data = fncSelectRecord($strTable,$strCondition);
$sql_update="update tb_contact set  status='yes' where con_id=".$_GET['id']." ";
...
<div>
  ...
  <div class="wapper">
    <div id="nav" ><a href="<?=$url_root;?>">หน้าหลัก</a> &gt; รายละเอียด</div>
<div>
    <div class="left_menu">
...
<div id="da-ex-tabs">
<h1>ข้อความจาก    <font color="red"><?=$data[name];?></font></h1>
<p>เบอร์ติดต่อ : <?=$data[mobile];?></p>
<p>อีเมล์ : <?=$data[email];?></p>
