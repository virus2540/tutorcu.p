...
<form class="da-form" id="da-ex-validate2" method="POST" action="./edit-bank-complete.php?id=<?=$_GET[id];?>" enctype="multipart/form-data">
                                    	<div class="da-form-inline">
                                            <div class="da-form-row">
                                                <label>ธนาคาร</label>
                                                <div class="da-form-item large">
                                                    <input type="text" name="bank_name" value="<?=$data[bank_name];?>" class="required"/>
                                                </div>
                                            </div>
									</div>
                                    	<div class="da-form-inline">
                                            <div class="da-form-row">
                                                ...
                                                <div class="da-form-item large">
                                                    <input type="text" name="bank_acc" value="<?=$data[bank_acc];?>" class="required"/>
                                                </div>
                                            </div>
									</div>
                                    	<div class="da-form-inline">
                                            <div class="da-form-row">
                                                ...
                                                <div class="da-form-item large">
                                                    <input type="text" name="bank_no" value="<?=$data[bank_no];?>" class="required"/>
                                                </div>
                                            </div>
									</div>
                                    	<div class="da-form-inline">
                                            <div class="da-form-row">
                                                <label>สาขา</label>
                                                <div class="da-form-item large">
                                                    <input type="text" name="bank_blance" id="bank_blance" value="<?=$data[bank_blance];?>" class="required"/>
