...
<div class="wrapper fadeInDown">
  ...
  <div id="formContent">
    ...
    <h4 class="mt-3 mb-3">Members Panel</h4>
    ...
    <form action="./login_check.php" method="POST">
      ...
      <a href="#" class="btn fadeIn mt-3 mb-3" role="button" style="padding: 10px 71px;color: white;background-color: #efa43e;border-color: #efa43e;">Register</a>
